...
class ASRModel(torch.nn.Module):
    ...
    def __init__(
        ...
        self.pdf_ce_loss = LabelSmoothingLoss(
            size=pdf_size,
    ...
    def unpack_train_data(self, batch_data, device):
        return batch_data['feats'].size(0), \
            ...
            batch_data['pdf_ali'].to(device), batch_data['pdf_ali_lengths'].to(device), \
    ...
    def forward(
        ...
        pdf_ali: torch.Tensor,
        pdf_ali_lengths: torch.Tensor,
        ...
        assert (speech.shape[0] == speech_lengths.shape[0] == 
                ...
                pdf_ali.shape[0]==pdf_ali_lengths.shape[0]==
                ...
                text.shape, text_lengths.shape, pdf_ali.shape, pdf_ali_lengths.shape, pdf_ali_no_repeat.shape, pdf_ali_no_repeat_lengths.shape,
        ...
        pdf_ce_loss_= self.pdf_ce_loss(encoder_out, pdf_ali) 
        ...
        loss = self.pdf_ce_weight*pdf_ce_loss_  +  self.pdf_attention_weight*pdf_attention_loss_ + self.phone_attention_weight*phone_attention_loss_ + self.vacab_attention_weight*vacab_attention_loss_
        
        return loss, dict(pdf_ce_loss=pdf_ce_loss_, pdf_attention_loss=pdf_attention_loss_, phone_attention_loss=phone_attention_loss_, vacab_attention_loss=vacab_attention_loss_)
    ...
    def get_logprobs(
        ...
        return self.pdf_ce_loss.get_logprobs(encoder_out)
    ...
    def get_probs(
        ...
        return self.pdf_ce_loss.get_probs(encoder_out)
