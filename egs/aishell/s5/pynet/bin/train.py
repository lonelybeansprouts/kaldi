...
from pynet.utils.checkpoint import (load_checkpoint, save_checkpoint,
                                    load_trained_modules)
from pynet.utils.executor import Executor
from pynet.utils.file_utils import read_symbol_table, read_non_lang_symbols, read_lists
from pynet.utils.scheduler import WarmupLR
...
def get_args():
    ...
    parser.add_argument('--pdf_num',
                        required=True,
                        help='file to provide pdf_num')
    parser.add_argument('--phone_num',
                        required=True,
                        help='file to provide phone_num')
...
def main():
    ...
    pdf_size = int(read_lists(args.pdf_num)[0]) + 1 #extra pos for sos/eos
    phone_size = int(read_lists(args.phone_num)[0]) + 1 #extra pos for sos/eos

    vocab_size = len(symbol_table)

    # Save configs to model_dir/train.yaml for inference and export
    configs['input_dim'] = input_dim
    configs['pdf_size'] = pdf_size 
    configs['phone_size'] = phone_size
