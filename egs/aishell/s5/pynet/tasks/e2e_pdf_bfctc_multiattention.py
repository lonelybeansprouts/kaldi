...
class ASRModel(torch.nn.Module):
    ...
    def forward(
        ...
        assert (pdf_ali.dtype == torch.int32)
        assert (pdf_ali_lengths.dtype == torch.int32)
        ...
        pdf_ce_loss_, pdf_bfctc_loss_ = self.pdf_ce_ctc_loss(encoder_out, pdf_ali, pdf_ali_no_repeat, speech_lengths, pdf_ali_no_repeat_lengths) 
