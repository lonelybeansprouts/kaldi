...
class ASRModel(torch.nn.Module):
    ...
    def __init__(
        ...
        self.pdf_bfctc_loss = LabelBFCTCLoss(
            size=pdf_size,
    ...
    def forward(
        ...
        return loss, dict(pdf_bfctc_loss=pdf_bfctc_loss_, pdf_attention_loss=pdf_attention_loss_, phone_attention_loss=phone_attention_loss_, vacab_attention_loss=vacab_attention_loss_)
